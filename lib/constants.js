...
export const WEATHER_CACHE_KEY = 'rootcause_weather_v2'
export const WEATHER_CACHE_TIME_KEY = 'rootcause_weather_time_v2'
...
export const PLANT_MATURITY_KEY = 'rootcause_plant_maturity'
export const GARDEN_KEY = 'rootcause_my_garden'
